...
# question 1.1 : les 2 processus accèdent à la ressource critique en même temps. Il faut alors protéger les ressources critiques et la section critique.
# on a les 2 processus qui sont dans la section critique en meme temps
# question 1.2 : tprint permet de print avec lheure/ date
...
# Les semaphores
# question 1.4 : ajout de semaphore
...
def thread_P1(nom) :
    ...
    for i in range(NbCoups):
        ...
        s.acquire() # on recupère le sémaphore
	...
	# fin de section critique
        s.release() # on libère le sémaphore
